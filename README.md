...
pyinstaller --onefile --windowed --name zcodeDesktop --icon icon.ico   --collect-all webview --collect-all clr --collect-all requests   --add-data "widget.html;." --add-data "icon.ico;." widget.py
```
